      ...
      <div className="space-y-4">
            ...
            {scales.map((scale) => (
              <div key={scale.id} className="relative group">
                  <MyScaleCard
                    ...
                    icon={scale.status === 'CONFIRMADO' ? <FaCheck className="text-sm" /> : <FaRegClock className="text-sm" />}
                    status={scale.status}
                  />
        ...
        {availableScales.length > 0 && (
          <div className="mt-4 pt-4 border-t border-white/10">
            <h4 className="text-xs text-gray-400 mb-3 uppercase tracking-wider">Escalas disponíveis</h4>
            <div className="space-y-3">
